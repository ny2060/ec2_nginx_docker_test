      ...
      <VStack className="min-h-full pb-8 bg-gray-50">
        ...
        <VStack className="w-full px-6">
          ...
          <VStack className="rounded-2xl w-full bg-white shadowed px-6 py-4 mb-4 !gap-0">
            <HStack className="justify-between w-full pb-4 mb-4 border-b border-gray-200">
            ...
            <HStack className="justify-end items-end !gap-0">
              <span className="text-gray-500 font-sm">잔액</span>
              <Spacer />
          ...
          <HStack className="justify-between w-full py-4 border-b border-gray-200">
            <span> 알림설정 </span>
            <Toggle
